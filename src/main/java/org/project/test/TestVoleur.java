...
import org.project.modele.Voleur;
...
public class TestVoleur {
    ...
    public void test2() {
        ...
        // tests:
        if(roi.getEstVole()) {
            Test.test(roi.getEstVole(), "le roi est volé");
        }
        else {
            Test.test(!roi.getEstVole(), "le roi n'est pas volé");
        }
    }

    public void test3() {
        System.out.println("TEST DU VOL DU ROI AVEC L'AVATAR");
        PlateauDeJeu plateau = new PlateauDeJeu();
