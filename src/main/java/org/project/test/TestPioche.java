...
public class TestPioche {
    ...
    public void test1() {
        ...
        Test.test(pioche.nombreQuartiersDansPioche() == 0, "taille de la pioche");
    }
    ...
    public void test2() {
        ...
        Test.test(pioche.nombreQuartiersDansPioche() == 3, "taille de la pioche");
    }
    ...
    public void test3() {
        ...
        pioche.ajouter(quartier3);
        q = pioche.piocher();
        Test.test(pioche.nombreQuartiersDansPioche() == 2 && q == quartier1, "test d'un retrait dans une pioche composée de trois cartes");
        q = pioche.piocher();
        Test.test(pioche.nombreQuartiersDansPioche() == 1 && q == quartier2, "test d'un retrait dans une pioche composée de deux cartes");
        q = pioche.piocher();
        Test.test(pioche.nombreQuartiersDansPioche() == 0 && q == quartier3, "test d'un retrait dans une pioche composée d'une seule carte");
    }
    ...
    public void test4() {
        ...
        pioche.melanger();
        Test.test(pioche.nombreQuartiersDansPioche() == 10, "taille de la pioche après mélange");
        System.out.println("Affichage de la pioche après mélange : ");
        for (int i = pioche.nombreQuartiersDansPioche(); i > 0; i--) {
            q = pioche.piocher();
