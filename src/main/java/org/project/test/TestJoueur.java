...
public class TestJoueur {
    ...
    public void test1() {
        ...
        Test.test(joueur.getTresor() == 0, "test du trésor initial du joueur");
    ...
    public void test2() {
        ...
        Test.test(joueur.getTresor() == 3, "test de l'ajout d'un nombre de pièces");
        joueur.ajouterPieces(-2);
        Test.test(joueur.getTresor() == 3, "test d'ajout d'un nombre de pièces négatif");
        joueur.retirerPieces(-1);
        Test.test(joueur.getTresor() == 3, "test d'un retrait d'un nombre négatif de pièces");
        joueur.retirerPieces(4);
        Test.test(joueur.getTresor() == 3, "test de retrait d'un trop grand nombre de pièces");
        joueur.retirerPieces(2);
        joueur.retirerPieces(1);
        Test.test(joueur.getTresor() == 0, "test de retrait d'un nombre de pièces");
    }
    ...
    public void test3() {
        ...
        joueur.retirerQuartierDansCite("prison");
        Test.test(joueur.nbQuartiersDansCite() == 2, "test de retrait d'un quartier");
    ...
    public void test5() {
        ...
        Test.test(joueur.nbQuartiersDansMain() == 0 && joueur.nbQuartiersDansCite() == 0
                && joueur.getTresor() == 0, "test de la réinitialisation");
    }
