...
import org.project.modele.Caracteristiques;
...
public class TestRoi {
    ...
    public void test6() {
        ...
        Joueur joueur = new Joueur("Billy");
        Roi roi = new Roi();
        roi.ajouterQuartierDansMain(quartier1);
        Test.test(roi.getJoueur() == null, "test alors que le joueur n'est pas attribué");
        roi.setJoueur(joueur);
        roi.ajouterQuartierDansMain(quartier1);
        roi.ajouterQuartierDansMain(quartier2);
        roi.ajouterQuartierDansMain(quartier3);
