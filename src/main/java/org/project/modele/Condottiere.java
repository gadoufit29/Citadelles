        ...
        public void utiliserPouvoir() {
            ...
            if(utiliserPouvoir){
                ...
                do{
                    ...
                    if(this.getPlateau().getJoueur(choixJoueur - 1).getCite().isEmpty()){
                        System.out.println("Vous ne pouvez pas détruire de quartier chez un joueur qui n'a pas de quartier !");
                    }

                    else if (this.getPlateau().getJoueur(choixJoueur - 1).getCite().size() >= 7) {
                        ...
                        do {
                            ...
                            if(listeJoueurs.get(choixJoueur - 1).getCite().get(choixQuartier - 1).getNom() == "Donjon"){
                                ...
                                if(this.getJoueur().getTresor() >= (listeJoueurs.get(choixJoueur - 1).getCite().get(choixQuartier - 1).getCoutConstruction() - 1)){
                                    ...
                                    this.getPlateau().getPioche().ajouter(listeJoueurs.get(choixJoueur - 1).getCite().get(choixQuartier - 1));
